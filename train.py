...
# from torch_xla.core.xla_model import XLAModel
import torch_xla.core.xla_model as xm
# from torch_xla.distributed.parallel import XLAOptim
...
temp_file_path = "/kaggle/working/temp_file.txt" # modify the path to the platforms file structure you're gonna use tot train on
...
optimizer = torch.optim.AdamW(model.parameters(), lr=learning_rate)# print the number of parameters in the model
print(sum(p.numel() for p in model.parameters())/1e6, 'M parameters')

# create a PyTorch optimizer
optimizer = torch.optim.AdamW(tpu_model.parameters(), lr=learning_rate)
